...
struct AnyHintUnion {
  ...
  AnyHintUnion(const AnyHintUnion &);
  AnyHintUnion &operator=(const AnyHintUnion &u)
...
struct AnyLayerUnion {
  ...
  AnyLayerUnion(AnyLayerUnion&& u) FLATBUFFERS_NOEXCEPT :
    ...
    { std::swap(type, u.type); std::swap(value, u.value); }
  AnyLayerUnion(const AnyLayerUnion &);
  AnyLayerUnion &operator=(const AnyLayerUnion &u)
...
inline MetaT *Meta::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<platforms::darwinn::MetaT> _o = std::unique_ptr<platforms::darwinn::MetaT>(new MetaT());
...
inline FieldOffsetT *FieldOffset::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<platforms::darwinn::FieldOffsetT> _o = std::unique_ptr<platforms::darwinn::FieldOffsetT>(new FieldOffsetT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline InstructionBitstreamT *InstructionBitstream::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<platforms::darwinn::InstructionBitstreamT> _o = std::unique_ptr<platforms::darwinn::InstructionBitstreamT>(new InstructionBitstreamT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline DmaDescriptorHintT *DmaDescriptorHint::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<platforms::darwinn::DmaDescriptorHintT> _o = std::unique_ptr<platforms::darwinn::DmaDescriptorHintT>(new DmaDescriptorHintT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline InterruptHintT *InterruptHint::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<platforms::darwinn::InterruptHintT> _o = std::unique_ptr<platforms::darwinn::InterruptHintT>(new InterruptHintT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline InstructionHintT *InstructionHint::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<platforms::darwinn::InstructionHintT> _o = std::unique_ptr<platforms::darwinn::InstructionHintT>(new InstructionHintT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline FenceHintT *FenceHint::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<platforms::darwinn::FenceHintT> _o = std::unique_ptr<platforms::darwinn::FenceHintT>(new FenceHintT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline DmaHintT *DmaHint::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<platforms::darwinn::DmaHintT> _o = std::unique_ptr<platforms::darwinn::DmaHintT>(new DmaHintT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline DmaHintsT *DmaHints::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<platforms::darwinn::DmaHintsT> _o = std::unique_ptr<platforms::darwinn::DmaHintsT>(new DmaHintsT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline OutputLayoutT *OutputLayout::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<platforms::darwinn::OutputLayoutT> _o = std::unique_ptr<platforms::darwinn::OutputLayoutT>(new OutputLayoutT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline TensorShapeT *TensorShape::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<platforms::darwinn::TensorShapeT> _o = std::unique_ptr<platforms::darwinn::TensorShapeT>(new TensorShapeT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline TensorLayoutT *TensorLayout::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<platforms::darwinn::TensorLayoutT> _o = std::unique_ptr<platforms::darwinn::TensorLayoutT>(new TensorLayoutT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline OutputShapeInfoT *OutputShapeInfo::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<platforms::darwinn::OutputShapeInfoT> _o = std::unique_ptr<platforms::darwinn::OutputShapeInfoT>(new OutputShapeInfoT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline NumericsConstantsT *NumericsConstants::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<platforms::darwinn::NumericsConstantsT> _o = std::unique_ptr<platforms::darwinn::NumericsConstantsT>(new NumericsConstantsT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline OutputLayerT *OutputLayer::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<platforms::darwinn::OutputLayerT> _o = std::unique_ptr<platforms::darwinn::OutputLayerT>(new OutputLayerT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline InputLayerT *InputLayer::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<platforms::darwinn::InputLayerT> _o = std::unique_ptr<platforms::darwinn::InputLayerT>(new InputLayerT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline LayerT *Layer::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<platforms::darwinn::LayerT> _o = std::unique_ptr<platforms::darwinn::LayerT>(new LayerT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline ExecutableT *Executable::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<platforms::darwinn::ExecutableT> _o = std::unique_ptr<platforms::darwinn::ExecutableT>(new ExecutableT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline MultiExecutableT *MultiExecutable::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<platforms::darwinn::MultiExecutableT> _o = std::unique_ptr<platforms::darwinn::MultiExecutableT>(new MultiExecutableT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline SerializedPackageT *SerializedPackage::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<platforms::darwinn::SerializedPackageT> _o = std::unique_ptr<platforms::darwinn::SerializedPackageT>(new SerializedPackageT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline void SerializedPackage::UnPackTo(SerializedPackageT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = serialized_package(); if (_e) { _o->serialized_package.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->serialized_package[_i] = _e->Get(_i); } } }
}
...
inline PackageT *Package::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<platforms::darwinn::PackageT> _o = std::unique_ptr<platforms::darwinn::PackageT>(new PackageT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline AnyHintUnion::AnyHintUnion(const AnyHintUnion &u) : type(u.type), value(nullptr) {
  switch (type) {
    case AnyHint_DmaDescriptorHint: {
...
inline AnyLayerUnion::AnyLayerUnion(const AnyLayerUnion &u) : type(u.type), value(nullptr) {
  switch (type) {
    case AnyLayer_OutputLayer: {
